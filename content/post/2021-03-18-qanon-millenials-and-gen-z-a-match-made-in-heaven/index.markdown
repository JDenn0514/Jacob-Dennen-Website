...
Looking to the graph below, we can see that Millennials and Gen X’ers agree with QAnon more than any other generation as roughly 48% and 46% of the respondents agreed, respectively. Following them was the Silent Generation with 39% and Gen Z with 36.8%. Surprisingly, **Boomers had the lowest levels** of agreement with only 35.4%. This demonstrates that although Boomers may spread more false information, they don’t believe in conspiracy theories (at least QAnon) as much as other generations, particularly Gen X and Millennials.
...
We can see in the graph below that QAnon has the biggest impact on antisemitic sentiment among Millennials and Gen Z. In fact, we can see that the effect QAnon has on antisemitic sentiment increases dramatically for younger generations. For Gen Z, the difference among QAnon and non-QAnon followers is 2.76 antisemitic tropes (e.g., “Jews killed Jesus.”), for Millennials it is 2.54 tropes, for Gen X it is 1.79, Boomers it is 0.54, and for the Silent Generation it is 0.88 tropes. Put another way, overt antisemitic sentiment increases by 154% among Gen Z QAnon followers, but for Boomers it increases by only 33%.  This might be attributed to older generations’ exposure to the Holocaust which limits what parts of the QAnon conspiracy theory they are willing to believe, such as the [antisemitic](https://www.jta.org/2020/09/18/politics/qanon-is-an-old-form-of-anti-semitism-in-a-new-package-experts-say) aspects. Unfortunately, young people do not have this limiter and are more willing to accept many more aspects of QAnon theories.
